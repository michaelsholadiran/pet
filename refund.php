    ...
    <main>
        <section class="policy-section">
            ...
            <article>
                ...
                <table>
                    <thead>
                        <tr><th>Reason for Return</th><th>Shipping Cost Responsibility</th></tr>
                    </thead>
                    <tbody>
                        <tr><td><strong>Defective, Damaged, or Quality Failure (24-Month Promise)</strong></td><td>Puppiary covers all return and replacement shipping costs.</td></tr>
                        <tr><td><strong>Change of Mind or Not the Right Fit (30-Day Guarantee)</strong></td><td>The customer is responsible for return shipping costs.</td></tr>
                    </tbody>
                </table>
            </article>
            <article>
