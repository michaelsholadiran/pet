<?php
/**
 * Site footer + default scripts + floating Talk to a Vet / WhatsApp buttons.
...
?>
    ...
    <a href="https://wa.me/2347016426458" target="_blank" rel="noopener noreferrer" class="vet-float" aria-label="Talk to a Vet on WhatsApp" title="Talk to a Vet">
        <svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true">
            <path fill="currentColor" d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm0 13.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08s5.97 1.09 6 3.08c-1.29 1.94-3.5 3.22-6 3.22zM15 9h-2V7h-2v2H9v2h2v2h2v-2h2V9z"/>
        </svg>
