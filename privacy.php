    ...
    <main>
        <section class="policy-section">
            ...
            <article>
                ...
                <table>
                    <thead>
                        <tr><th>Purpose</th><th>Information Used</th><th>Why it is Necessary</th></tr>
                    </thead>
                    <tbody>
                        <tr><td><strong>Order Fulfillment</strong></td><td>Name, Address, Payment Info</td><td>Processing and shipping your order, ensuring accurate delivery.</td></tr>
                        <tr><td><strong>Essential Communication</strong></td><td>Email, Phone</td><td>Sending order confirmations, tracking updates, and critical delivery notifications.</td></tr>
                        <tr><td><strong>Customer Support</strong></td><td>Name, Email, Order Details</td><td>Responding to inquiries about your order, returns, and guarantee claims.</td></tr>
                        <tr><td><strong>Improving Our Service</strong></td><td>Usage Data, Cookies</td><td>Analyzing general website usage (not individual user data) to improve the shopping experience and site functionality.</td></tr>
                    </tbody>
                </table>
            </article>
            <article>
