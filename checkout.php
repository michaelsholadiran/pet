            ...
            <div class="checkout-container">
                <form id="checkout-form" class="checkout-form">
                    ...
                    <div class="accepted-payment-methods">
                        ...
                        <div class="payment-methods-grid">
                            <div class="payment-method-item" title="PayPal">
                                <svg viewBox="0 0 24 24" width="32" height="32" aria-hidden="true"><path fill="#003087" d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/></svg>
                                <span>PayPal</span>
                            </div>
                ...
                <aside class="checkout-summary" aria-label="Order Summary">
                    ...
                    <div class="checkout-social-proof">
                        <div class="social-proof-item"><svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true"><path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg><span>Trusted by 2,500+ customers</span></div>
                        <div class="social-proof-item"><svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true"><path fill="currentColor" d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><span><?php echo htmlspecialchars(puppiary_delivery_window_text()); ?></span></div>
                    </div>
